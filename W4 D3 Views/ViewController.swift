...
//        view.addSubview(label)
        ...
        let greenView = UIView(frame: CGRect(x: 0, y: lightBlue.frame.maxY, width: screenWidth, height: screenHeight/4))
        greenView.backgroundColor = UIColor.green
        view.addSubview(greenView)
        
        let redViewHeight = screenHeight - orangeView.frame.height - darkBlue.frame.height - greenView.frame.height
        let redView = UIView(frame: CGRect(x: 0, y: greenView.frame.maxY, width: screenWidth, height: redViewHeight))
